...
public class HomeActionBean extends BaseActionBean {
  ...
  public Resolution view() {
    boolean httpThis = Boolean.parseBoolean(getContext().getRequest().getParameter("no-haters"));
    if (checkCookie("no-haters") == null) {
      Cookie c = new Cookie("no-haters", "only-players");
      c.setHttpOnly(httpThis);
  ...
  private Cookie checkCookie(String key) {
    Cookie cookie = null;
